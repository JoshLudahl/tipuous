...
class TipCalculatorTest {
    ...
    fun `adding 10 tax increases the total by at least 10`() {
        ...
        val baseResult = calculator.calculate(
            billAmount = 100.0,
            tipPercentEnum = Percent.TWENTY,
            customTipPercent = 20,
            splitCount = 1,
        ...
        val taxResultPreTax = calculator.calculate(
            billAmount = 100.0,
            tipPercentEnum = Percent.TWENTY,
            customTipPercent = 20,
            splitCount = 1,
        ...
        val taxResultOnTotal = calculator.calculate(
            billAmount = 100.0,
            tipPercentEnum = Percent.TWENTY,
            customTipPercent = 20,
            splitCount = 1,
    ...
    fun `toggling pre-tax switch correctly changes tip amount`() {
        ...
        val preTaxOff = calculator.calculate(
            billAmount = bill,
            tipPercentEnum = Percent.TWENTY,
            customTipPercent = 20,
            splitCount = 1,
